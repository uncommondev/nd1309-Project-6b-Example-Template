...
// Import access control libraries
...
contract SupplyChain is ConsumerRole, DistributorRole, FarmerRole, RetailerRole {
  ...
  function harvestItem(uint _upc, address ownerID, address _originFarmerID, string _originFarmName, string _originFarmInformation, string  _originFarmLatitude, string _originFarmLongitude, uint _productID, string _productNotes, uint _productPrice) public onlyFarmer
  {
